...
- API: add global exception handlers (incl. request_id in error bodies + X-Request-ID header) (+ tests).
...
- API: application detail now includes latest queue_info when present (+ tests).
