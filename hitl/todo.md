...
Tasks:
- [x] Create QueueService class
- [x] Implement create_queue_entry():
  - [x] Calculate priority using calculate_queue_priority()
  - [x] Set SLA deadline (default: 8 hours from creation)
  - [x] Store score_at_routing
  - [x] Store routing_reason
- [ ] Create GET endpoint
- [ ] Query parameters:
...
- [x] Test: Queue entries created correctly
- [x] Test: Priority calculated per spec
