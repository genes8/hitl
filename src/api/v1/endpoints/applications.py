...
from src.crud.similar_case import get_similar_cases_for_application
...
async def get_application_endpoint(
    ...
    similar_cases = await get_similar_cases_for_application(session=session, application_id=app.id)
